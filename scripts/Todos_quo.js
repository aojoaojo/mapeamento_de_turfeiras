...
//var p = table.set('Classes', 1);

//var t = table3.set('Classes', 1);
...
//Map.addLayer(table,{}, 'turfeirasref', false);
...
var featureSpace = s1_ndvi_mean.addBands([s1_ndvi_mean, s1_ndvi_min, s1_ndvi_stdDev, 
s2_ndvi_mean, s2_ndvi_min, s2_ndvi_stdDev, l8_ndvi_mean, l8_ndvi_min, l8_ndvi_stdDev,
l8_qtb_mean, l8_qtb_min, l8_qtb_stdDev, l8_qtg_mean, l8_qtg_min, l8_qtg_stdDev, 
l8_qtr_mean, l8_qtr_min, l8_qtr_stdDev, s2_qtb_mean, s2_qtb_min, s2_qtb_stdDev, s2_qtg_mean, s2_qtg_min, s2_qtg_stdDev, 
s2_qtr_mean, s2_qtr_min, s2_qtr_stdDev]);
